        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    {{-- <li><a class="sidebar-sub-toggle"><i class="ti-home"><a href="index.html"></i> Dashboard <span> --}}
                                {{-- phpclass="badge badge-primary">2</span> <span
                    ...
                    <li class="nav-item @if(Request::is('siswa*')) active @endif">
                        <a class="nav-link" href="/siswa"><i class="ti-user">
                        </i> Siswa </a></li> --}}



                    <li><a href="app-email.html"><i class="ti-email"></i>Buku</a></li>
                    {{-- <li><a href="app-profile.html"><i class="ti-user"></i> History</a></li> --}}
